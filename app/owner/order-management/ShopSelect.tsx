...
import useGetShopListByOwnerIdQuery from '../inventory-management/hooks/useGetShopListByOwnerIdQuery'
...
const ShopSelect = () => {
  ...
  const [currentShopId, setCurrentShopId] = useOrderManagementStore(
